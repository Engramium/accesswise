...
class AdminMenu {
	...
	public function admin_menu() {
		...
		if ( current_user_can( $capability ) ) {
			$submenu[$this->slug][] = [ __( 'Welcome', 'accesswise' ), $capability, 'admin.php?page=' . $this->slug . '#/' ];
			$submenu[$this->slug][] = [ __( 'Settings', 'accesswise' ), $capability, 'admin.php?page=' . $this->slug . '#/settings' ];
		}
	}
